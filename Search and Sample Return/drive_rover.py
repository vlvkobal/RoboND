...
class RoverState():
    def __init__(self):
        ...
        self.prev_pos = [0, 0] # Rover position in previous iteration
        self.stuck = 0 # Probability of getting stuck
        self.mapped = 0 # Percentage of mapped terrain
        self.init_pos = None # Starting point
